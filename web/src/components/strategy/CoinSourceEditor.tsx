...
import { Plus, X, Database, TrendingUp, TrendingDown, List, Ban, Zap, BarChart2, Shuffle } from 'lucide-react'
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <label className="flex items-center gap-3 cursor-pointer pl-8">
              <input
                type="checkbox"
                checked={config.filter_hyperliquid}
                onChange={(e: ChangeEvent<HTMLInputElement>) =>
                  !disabled && onChange({ ...config, filter_hyperliquid: e.target.checked })
                }
                disabled={disabled}
      ...
      {config.source_type === 'mixed' && (
        <div className="p-4 rounded-lg bg-blue-500/5 border border-blue-500/20">
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            ...
            {/* OI Top Card */}
            <div
              className={`p-3 rounded-lg border transition-all cursor-pointer ${config.use_oi_top
            ...
            {/* OI Low Card */}
            <div
              className={`p-3 rounded-lg border transition-all cursor-pointer ${config.use_oi_low
            ...
            {/* Static/Custom Card */}
            <div
              className={`p-3 rounded-lg border transition-all cursor-pointer ${(config.static_coins || []).length > 0
